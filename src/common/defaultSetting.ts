...
const defaultSetting: LX.AppSetting = {
  ...
  'aiRecommend.enable': false,
  'aiRecommend.provider': 'openai',
  'aiRecommend.apiKey': '',
  'aiRecommend.apiHost': '',
  'aiRecommend.model': '',
  'aiRecommend.maxTokens': 4096,
  'aiRecommend.temperature': 0.7,
  'aiRecommend.recommendCount': 20,
  'aiRecommend.lastListId': '',
  'aiRecommend.customPrompt': '',
