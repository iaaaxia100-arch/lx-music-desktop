...
declare global {
  ...
  declare namespace LX {
    ...
    interface AppSetting {
       ...
       * 是否启用 AI 智能推荐
       */
      'aiRecommend.enable': boolean

      /**
       * AI 推荐 - API 提供商
       */
      'aiRecommend.provider': 'openai' | 'anthropic' | 'custom'

      /**
       * AI 推荐 - API 密钥
       */
      'aiRecommend.apiKey': string

      /**
       * AI 推荐 - API 地址
       */
      'aiRecommend.apiHost': string

      /**
       * AI 推荐 - 模型名称
       */
      'aiRecommend.model': string

      /**
       * AI 推荐 - 最大 Token 数
       */
      'aiRecommend.maxTokens': number

      /**
       * AI 推荐 - 创意度 (Temperature)
       */
      'aiRecommend.temperature': number

      /**
       * AI 推荐 - 每次推荐的歌曲数量
       */
      'aiRecommend.recommendCount': number

      /**
       * AI 推荐 - 上次选择的歌单 ID
       */
      'aiRecommend.lastListId': string

      /**
       * AI 推荐 - 自定义提示词
       */
      'aiRecommend.customPrompt': string
    }
  }
